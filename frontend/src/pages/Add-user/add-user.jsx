...
export default function SuperAdminPage() {
    ...
    useEffect(() => {
        ...
        axios.get('https://dmsdemo-wt6x.onrender.com/users')
    ...
    const handleAddUser = () => {
        ...
        axios.post('https://dmsdemo-wt6x.onrender.com/users', newUser)
            .then(response => {
    ...
    const handleDeleteUser = () => {
        axios.delete(`https://dmsdemo-wt6x.onrender.com/users/${userToDelete}`)
            .then(response => {
